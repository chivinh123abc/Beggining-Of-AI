...
.PHONY: build-ai70 build-ai30 build-all clean help
...
build-all: build-ai70 build-ai30 ## Compile both parts
...
help: ## Show available commands
	@Write-Host ""; Write-Host "Available commands:" -ForegroundColor Cyan; Write-Host "  make build-ai70   - Compile AI70 (Drone Attack essay)"; Write-Host "  make build-ai30   - Compile AI30 (5-chapter AI exam)"; Write-Host "  make build-all    - Compile both parts"; Write-Host "  make clean        - Remove all LaTeX build artifacts"; Write-Host ""
